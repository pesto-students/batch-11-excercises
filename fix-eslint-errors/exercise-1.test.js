...
describe('Promise.each', () => {
  ...
  it('doesnt iterate with an empty array', () => Promise.each([], () => { throw new Error(); }).then((ret) => {
...
describe('Promise.prototype.each', () => {
  ...
  it('doesnt iterate with an empty array', () => Promise.resolve([])
    .each(() => {
      throw new Error();
    })
    .then((ret) => {
...
describe('mapSeries and each', () => {
  it('is mixed', () => Promise.mapSeries([1, 2, 3], (value) => value * 2)
    .then((result) => {
