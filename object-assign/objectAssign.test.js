...
describe("objectAssign", () => {
  ...
  it("should return { foo: 1, bar: 2, baz: 3 }", function() {
    expect(objectAssign({ foo: 1 }, { bar: 2 }, { baz: 3 })).toEqual({
      foo: 1,
      bar: 2,
      baz: 3
    });
  ...
  it("should return { foo: 1, bar: 3, baz: 4 }", function() {
    expect(objectAssign({ foo: 1, bar: 2 }, { bar: 3, baz: 4 })).toEqual({
      foo: 1,
      bar: 3,
      baz: 4
    });
  ...
  it("should change target arguments and not change source arguments", function() {
    ...
    expect(objectAssign(target, sourceOne, sourceTwo)).toEqual({
      foo: 1,
      bar: 2,
      baz: 3
    });
